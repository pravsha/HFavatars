...
type = body+head
scale = 1
filename = KatBowLi/KatBowLi.fbx
texdir = KatBowLi/textures
...
jointIndex = LeftHand = 40
jointIndex = Spine2 = 24
jointIndex = LeftHandIndex3 = 43
jointIndex = Hips = 0
jointIndex = Spine = 22
jointIndex = CC_Base_Tongue = 9
jointIndex = LeftShoulder = 37
jointIndex = CC_Base_Teeth = 8
...
jointIndex = Underwear Bottoms = 7
jointIndex = Head = 50
jointIndex = LeftHandThumb3 = 47
jointIndex = CC_Base_Eye = 5
jointIndex = LeftLeg = 18
jointIndex = RightHandIndex2 = 30
jointIndex = LeftForeArm = 39
